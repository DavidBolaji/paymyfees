    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div>
        ...
        {(passwordFocused || formData.password) && (
          <div className="mt-2 space-y-1">
            <motion.div 
              animate={{ 
                color: passwordCriteria.isUpperCase ? "#10b981" : "#ef4444"
              }}
              className="flex items-center text-xs"
            >
              <motion.span 
                animate={{ 
                  borderColor: passwordCriteria.isUpperCase ? "#10b981" : "#ef4444",
                  color: passwordCriteria.isUpperCase ? "#10b981" : "#ef4444"
                }}
                className="w-4 h-4 rounded-sm mr-2 flex items-center justify-center text-white border"
              >
                {passwordCriteria.isUpperCase ? "!" : "!"}
              </motion.span>
            ...
            <motion.div 
              animate={{ 
                color: passwordCriteria.hasMinLength ? "#10b981" : "#ef4444"
              }}
              className="flex items-center text-xs"
            >
              <motion.span 
                animate={{ 
                  borderColor: passwordCriteria.hasMinLength ? "#10b981" : "#ef4444",
                  color: passwordCriteria.hasMinLength ? "#10b981" : "#ef4444"
                }}
                className="w-4 h-4 rounded-sm mr-2 flex items-center justify-center text-white border"
              >
            ...
            <motion.div 
              animate={{ 
                color: passwordCriteria.hasSpecialChar ? "#10b981" : "#ef4444"
              }}
              className="flex items-center text-xs"
            >
              <motion.span 
                animate={{ 
                  borderColor: passwordCriteria.hasSpecialChar ? "#10b981" : "#ef4444",
                  color: passwordCriteria.hasSpecialChar ? "#10b981" : "#ef4444"
                }}
                className="w-4 h-4 rounded-sm mr-2 flex items-center justify-center text-white border"
              >
      ...
      <div className="flex items-start mt-4">
        <input
          ...
          "
        />
        <label htmlFor="terms" className="text-sm text-[#7C7C7C]">
          By clicking sign up, you agree to{" "}
          <Link href="/terms" className="text-[#00296B] hover:underline">
            PayMyFees User agreement
          </Link>
          ,{" "}
          <Link href="/privacy" className="text-[#00296B] hover:underline">
            Privacy policy
          </Link>
          .
        </label>
