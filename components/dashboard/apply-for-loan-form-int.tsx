...
export function ApplyForLoanFormInt() {
  ...
  // Form handlers
  const handleInputChange = (field: keyof LoanApplicationIntFormData, value: any) => {
  ...
  const handleConsentChange = (key: keyof NonNullable<LoanApplicationIntFormData['consents']>, checked: boolean) => {
    setFormData(prev => ({
      ...prev,
      consents: {
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              <FormSelect
                ...
                value={formData.programCourseOfStudy || ''}
                onChange={(e) => handleInputChange('programCourseOfStudy', e.target.value)}
                error={errors.programCourseOfStudy}
              />
