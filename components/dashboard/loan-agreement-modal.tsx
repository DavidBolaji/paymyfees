  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center bg-black/50 p-4">
      <motion.div
        ...
        className="bg-white rounded-2xl shadow-2xl border border-[#F2F2F2] w-full"
        style={{ width: '644px', maxWidth: '90vw', maxHeight: '90vh', padding: '23px 15px 20px', overflowY: 'auto' }}
      >
          ...
          <AnimatePresence mode="wait">
            ...
            {step === 1 && (
              ...
              >
                ...
                <div
                  ...
                  className="overflow-y-auto rounded-xl border border-[#d1d1d1] bg-[#f5f5f5] p-4 text-base text-[#292929] leading-relaxed whitespace-pre-wrap"
                  style={{ height: '340px' }}
                >
                  {AGREEMENT_TEXT}
                </div>
            ...
            {step === 2 && (
              <motion.div key="s3"
                initial={{ opacity: 0, x: 16 }} animate={{ opacity: 1, x: 0 }}
                exit={{ opacity: 0, x: -16 }} transition={{ duration: 0.15 }}
                className="px-2 py-4 flex flex-col items-center text-center"
              >
                {accepted ? (
                  <motion.div
