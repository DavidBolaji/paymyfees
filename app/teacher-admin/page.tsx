...
import { Users, BookOpen, CheckCircle, Clock, XCircle } from 'lucide-react';
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        {loading ? (
          ...
          <>
            ...
            <StatCard title="Approved / Disbursed" value={stats?.approvedLoans ?? 0} icon={<CheckCircle className="w-5 h-5" />} />
            <StatCard title="Rejected" value={stats?.rejectedLoans ?? 0} icon={<XCircle className="w-5 h-5" />} />
          </>
        )}
      </div>
