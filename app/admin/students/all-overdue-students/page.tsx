...
export default function AllOverdueStudentsPage() {
  ...
  return (
    <div className="bg-[#F6F6F6] min-h-full p-4 sm:p-6 md:p-8">
      ...
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-[#191919]">Overdue Student Loans</h1>
        <p className="text-[#5F5F5F] mt-1">Students with overdue or defaulted loan payments.</p>
      </div>
