...
export default function StudentsPage() {
  ...
  const TABS: { id: Tab; label: string }[] = [
    ...
    { id: 'overdue', label: 'Overdue Student Loans' },
    { id: 'completed', label: 'Completed Student Loans' },
  ];
  ...
  return (
    <div className="bg-[#F6F6F6] min-h-full p-4 sm:p-6 md:p-8">
      ...
      <div className="mb-6">
        ...
        <p className="text-[#5F5F5F] mt-1">Monitor, segment, and manage students across the full loan lifecycle.</p>
      </div>
