...
const WalletCard: React.FC<WalletCardProps> = ({ balance, currency = 'NGN', virtualAccountNumber, virtualAccountBank }) => {
  ...
  return (
    <div
      className="w-full min-h-[210px] sm:min-h-[250px] md:min-h-[269px] rounded-[20px] px-4 sm:px-5 md:px-[29px] py-5 sm:py-7 md:py-[41px] relative text-white font-sans shadow-xl overflow-hidden"
      style={{
    ...
    >
      ...
      <div className="relative z-10 flex flex-col gap-[21px] h-full">
        ...
        <div className="mt-auto space-y-1">
          ...
          <div className="flex items-center gap-1 sm:gap-1.5 text-[8px] sm:text-[10px] text-white/70 leading-tight">
            <svg
              width="10"
              height="10"
              viewBox="0 0 12 12"
