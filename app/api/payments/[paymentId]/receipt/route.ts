 ...
 */
export const GET = asyncHandler(async (req: Request, context?: { params: { paymentId: string } }) => {
  ...
  if (!context || !context.params || !context.params.paymentId) {
  ...
  return await paymentController.getReceipt(req, context.params.paymentId, {
